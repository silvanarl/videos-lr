...
const InfoVideo = () => {
    return (
        ...
        <main className="info-main">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt pariatur doloribus dolor magni, blanditiis nostrum beatae repudiandae, quibusdam soluta distinctio et quod aliquid. Ab inventore earum natus atque nemo enim nam nobis ut quam, deleniti veritatis! Deserunt architecto ex ipsa.</p>
        </main>
        <style jsx="true">
            {`
            .info-main{
